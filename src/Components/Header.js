...
function Header() {
  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width sticky">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/">
          <img className="w-14 rounded rounded-full" src={profile} alt="logo" />
        </NavLink>
      ...
      >
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          <li className="pb-1 md:pb-0">
            <NavLink to="/" onClick={toggle} className={activeHeader}>
              Home
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink to="/about" onClick={toggle} className={activeHeader}>
              About
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
          ...
          <li className="pb-1 md:pb-0">
            <NavLink to="/projects" onClick={toggle} className={activeHeader}>
              Projects
            </NavLink>
          </li>
          <li>
            <NavLink to="/contact" onClick={toggle} className={activeHeader}>
              Contact
            </NavLink>
          </li>
          <li>
