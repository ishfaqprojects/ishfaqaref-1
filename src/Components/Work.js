  ...
  return (
    <article className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      ...
      <div className="flex justify-between pt-2">
        ...
        <p className={company?.includes("Texhverx")?"  text-green-text text-content text-xs md:text-sm font-light pl-1 min-w-fit" :"text-content text-xs md:text-sm font-light pl-1 min-w-fit"}>{duration}</p>
      </div>
    </article>
  );
}
